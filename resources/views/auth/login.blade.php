                                ...
                                <div class="text-center">
                                    ...
                                    <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <center><div class="col-md-20" width="200px">
                                        ...
                                        <center>
                                            <button class="btn btn-primary btn-user btn-block col-md-10 w-100" type="submit" >Login</button>
                                        </center> 
